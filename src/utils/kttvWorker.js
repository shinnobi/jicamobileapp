...
const featchWithTimeout = (url, options, timeout) => {
...
class KTTVWorker {
    ...
    getLocationAddress(location){
        ...
        return this.get('https://maps.vnpost.vn/api/reverse', { params }, 3 * Constants.timeout);
    }
    ...
    _request = function(method, endpoint, newData, timeout){
        ...
        return (
            featchWithTimeout(params.url, params, timeoutParam)
                .then(res => {
